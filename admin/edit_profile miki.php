...
if($row>0){
if($new==$confirm){
   $sql = "UPDATE login SET  email='$email', phone_no='$phone', pass_word='$new' where user_name='$user_name'";
...
<body>
    ...
    <div id="admin" class="hidden">
        ...
        <div id="content">
           <form action="" method="post" enctype="multipart/form-data"><?php if(isset($error)){
            foreach($error as $error){
               echo '<span id="error-msg">'.$error.'</span>';
            };
         };
         ?>
        <p style="color:gray;">leave blank if you dont want to change</p>
            ...
            <label> Old Password <input class="imp" name="old" id="password" type="password"></label><br>
